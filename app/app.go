...
var (
	_ simapp.App              = (*FuryunderverseApp)(nil)
	_ servertypes.Application = (*FuryunderverseApp)(nil)
)
...
func (app *FuryunderverseApp) Name() string { return app.BaseApp.Name() }
...
func (app *FuryunderverseApp) getSubspace(moduleName string) paramstypes.Subspace {
...
func (app *FuryunderverseApp) upgradeHandler() {
