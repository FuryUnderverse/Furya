...
This repository contains the source code & how to build the Furyunderverse mainnet, a Cosmos-based blockchain network that levarages the [CosmWasm](https://github.com/CosmWasm/cosmwasm) technology to integrate AI into the ecosystem.

## Getting Started

[These instructions](https://docs.furya.io/developers/tutorials/getting-setup) will get you a copy of the project up and running on your local machine for development and testing purposes. See [deployment](#deployment) for notes on how to deploy the project on a live system.
...
[Please visit the official hardware requirement for Furyunderverse mainnet here](https://docs.furya.io/developers/networks/mainnet#node-hardwarde-specification)
...
We use [SemVer](http://semver.org/) for versioning. For the versions available, see the [tags on this repository](https://github.com/furyunderverse/furya/tags). 

## Authors

* [Duc Le Pham](https://github.com/ducphamle2)

See also the list of [contributors](https://github.com/furyunderverse/furya/contributors) who participated in this project.
...
<!-- ## Run test
`make test-method PACKAGE=github.com/furyunderverse/furya/x/airequest/keeper METHOD=TestCalucateMol` -->
